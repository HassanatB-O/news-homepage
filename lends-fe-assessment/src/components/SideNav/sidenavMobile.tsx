...
export default function SideNavMobile(){
    return(
        <div className='side--nav' id='mobile-sidenav'>
            <aside className="side--div" style={{float: "right", color: "black !important"}}>
                <div>
                   <img src="/Image/down-arrow.svg" alt="" />
                </div>
                <p style={{color: "black !important"}}>Adedeji</p>
            </aside>
           <aside className='side--div' style={{"margin": "1.5em 0", "fontWeight": 600,
    "opacity": 1, clear: "right"}}>
                <div>
